...
**(a) குறுக்கச்சு $x$-அச்சுக்கு இணை**

(a) குறுக்கச்சு $x$-அச்சுக்கு இணையான அதிபரவளையத்தின் சமன்பாடு (படம் 5.29)

$$\frac{(x - h)^2}{a^2} - \frac{(y - k)^2}{b^2} = 1$$

ஆகும்.

முனைப்புள்ளிகள் $A(h + a, k)$ மற்றும் $A'(h - a, k)$ ஆகும். குவியங்கள் $S(h + c, k)$ மற்றும் $S'(h - c, k)$ ஆகும். இங்கு $c^2 = a^2 + b^2$.

இயங்குவரையின் சமன்பாடுகள் $x = h \pm \frac{a}{e}$.

---

படம் 5.30

**(b) குறுக்கச்சு $y$-அச்சுக்கு இணை**

(b) குறுக்கச்சு $y$-அச்சுக்கு இணையான அதிபரவளையத்தின் சமன்பாடு (படம் 5.30)

$$\frac{(y - k)^2}{a^2} - \frac{(x - h)^2}{b^2} = 1$$

ஆகும்.

முனைப்புள்ளிகள் $A(h, k + a)$ மற்றும் $A'(h, k - a)$ ஆகும். குவியங்கள் $S(h, k + c)$ மற்றும் $S'(h, k - c)$ ஆகும். இங்கு $c^2 = a^2 + b^2$.

இயங்குவரையின் சமன்பாடுகள் $y = k \pm \frac{a}{e}$.
