...
$$ax^3 + bx^2 + cx + d = 0$$ எனும் சமன்பாட்டின் மூலங்கள் பெருக்குத்தொடர்முறையில் இருப்பதற்கான நிபந்தனையைக் காண்க. இங்கு $$a, b, c, d \neq 0$$ எனக்கொள்க.

### தீர்வு

மூலங்கள் பெருக்குத்தொடர்முறையில் உள்ளன என்க. எனவே, அவற்றை $$\frac{\alpha}{\lambda}, \alpha, \alpha\lambda$$ எனக் கருதுக.
...
(3) $$\Rightarrow \alpha^3 = -\frac{d}{a}$$

(2) $$\div$$ (1) $$\Rightarrow \alpha = -\frac{c}{b}$$

எனவே,

$$
\alpha^3 = -\frac{c^3}{b^3}
$$

எனவே,

$$
-\frac{c^3}{b^3} = -\frac{d}{a} \Rightarrow ac^3 = b^3 d
$$
